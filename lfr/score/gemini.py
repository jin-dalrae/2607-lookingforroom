...
- Homes near Caltrain stations work too: tag +caltrain_adjacent and +caltrain_corridor for 4th & King, Bayshore, Dogpatch, or explicit "near Caltrain" / walk-to-station language in SF. South San Francisco is a separate city (~1hr to Market) — apply south_sf_penalty; do not treat the city name alone as Caltrain-adjacent.
